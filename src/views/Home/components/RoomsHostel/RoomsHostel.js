...
const RoomsInn = props => {
  ...
  return (
    <div className={clsx(classes.root, className)} {...rest}>
      <SectionHeader
        title="Kálmán Imre sétányi szobaválasztékunk"
        subtitle="Válaszd ezt a szálláshelyünket ha szórakozni vágysz. Vendégeink számára a zárt udvarunk kiváló találkozó és grillező hely. 2 féle szálláshellyel várunk, 6 ágyas hostel termekkel és 4 személyes comfort szobákkal:"
        data-aos="fade-up"
      />
