...
export const content = {
         ...
         headline:
           'A Kisfaludy Pályázat célja, hogy azok a Budapesten kívüli szálláshelyek is támogatásban részesüljenek, amelyek a korábbi fejlesztési programokból kimaradtak, különös figyelmet fordítva a kiemelt turisztikai térségekre. Az elnyert pályázati összegből mindkét szálláshelyünkön felújításokat végzünk. A pályázat segítségével modernizáljuk épületeinket, hogy még vonzóbbá és kényelmesebbé tegyünk szálló vendégeink számára.',
         textSolar:
           'Mindkét szálláshelyünk tetejére napelemek kerültek, amelyek teljes mértékben biztosítják a melegvízellátást és a világításhoz az áramot. A megújuló energia használatával hozzájárulunk környezetünk védelméhez is.',
         textFurdo:
           'A megújult fürdőkkel a szobák is további komfortfokozatot kaptak. Az esztétikus megjelenés az ott lakók kényelmét jól szolgálja. A fürdőszobában zuhanyzótálca van, pratikus és higiénikus. Panziónk minden szobájához tartozik fürdőszoba, ezek közül a fele teljeskörű felújításra került. Újra csempéztük őket és kicseréltük szanitereket.',
         textAblak:
